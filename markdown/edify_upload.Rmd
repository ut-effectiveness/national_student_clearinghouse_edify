...
## Prior to running all code chunks make sure you are connected to /Share/Research/National Student Clearing House
...
## Load Return Files
```{r}
nsc_enrolled <- read.csv("/Volumes/Share/Research/National Student Clearing House/nsc_return_files/05072024115223_se_loa_nsc_enr_upload.csv")
nsc_applicant <- read.csv("/Volumes/Share/Research/National Student Clearing House/nsc_return_files/05072024115223_se_loa_nsc_app_upload.csv")
nsc_inquiry <- read.csv("/Volumes/Share/Research/National Student Clearing House/nsc_return_files/05072024115223_se_loa_nsc_inq_upload.csv")
nsc_prospect <- read.csv("/Volumes/Share/Research/National Student Clearing House/nsc_return_files/05072024115223_se_loa_nsc_pro_upload.csv")
```
